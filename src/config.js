...
export const CONTRACT_DEFINITIONS = [
  ...
  {
    id: "night-shift", group: "shift", name: "Nachtdienst",
    description: "Schließe heute eine Nachtschicht ab.", icon: "🌙", target: 1, reward: 50,
    progress: { kind: "modeCompleted", mode: "nightshift" },
  },
  {
    id: "marathon-shift", group: "shift", name: "Langstrecke",
    description: "Schließe heute eine Marathon-Schicht ab.", icon: "🏃", target: 1, reward: 55,
    progress: { kind: "modeCompleted", mode: "marathon" },
  },
  {
...
export const MODES = {
  ...
  sprint: {
    ...
    timed: true,
    seconds: 45,
    expectedSecondsPerItem: 6,
    scoreMultiplier: 1.55,
    itemCount: 6,
    navigator: "carrying",
    comboWindow: 8,
    description: "Ultrakurze Schicht: sechs Dinge, 45 Sekunden, volle Belohnung.",
  },
  marathon: {
    label: "Marathon",
    icon: "🏃",
    timed: true,
    seconds: 300,
    expectedSecondsPerItem: 15,
    scoreMultiplier: 1.1,
    itemCount: 16,
    navigator: "carrying",
    comboWindow: 16,
    description: "Die lange Ausdauerschicht mit vielen gestaffelten Wellen.",
  },
  nightshift: {
    label: "Nachtschicht",
    icon: "🌙",
    timed: true,
    seconds: 130,
    expectedSecondsPerItem: 11,
    scoreMultiplier: 1.45,
    itemCount: 11,
    navigator: "off",
    comboWindow: 12,
    description: "Ohne Navigator: nur Überblick und Erinnerung führen ans Ziel.",
  },
  perfektionist: {
    label: "Perfektionist",
    icon: "🎯",
    timed: true,
    seconds: 150,
    expectedSecondsPerItem: 14,
    scoreMultiplier: 1.6,
    itemCount: 9,
    navigator: "always",
    comboWindow: 9,
    description: "Höchster Punktefaktor – aber jede Serie muss sitzen.",
  },
  zen: {
    label: "Zen",
    icon: "∞",
  ...
  flow: {
    ...
    timed: false,
    seconds: null,
    expectedSecondsPerItem: 13,
    scoreMultiplier: 0.95,
    itemCount: 14,
    navigator: "carrying",
    comboWindow: 22,
    description: "Zeitlos wie Zen, aber mit langer Serie und ganz ohne Dauerkompass.",
  },
};
...
export const ACHIEVEMENTS = [
  ...
  { id: "sprint-ace", name: "Sprintass", description: "Eine Sprint-Schicht rechtzeitig abschließen.", icon: "⏱️" },
  { id: "night-owl", name: "Nachteule", description: "Eine Nachtschicht ohne Zielhilfe meistern.", icon: "🌙" },
  { id: "endurance-crew", name: "Ausdauercrew", description: "Eine komplette Marathon-Schicht durchziehen.", icon: "🏃" },
  {
